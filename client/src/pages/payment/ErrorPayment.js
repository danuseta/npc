      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <div className="card bg-white shadow-sm p-8 text-center">
            ...
            <h1 className="text-2xl font-bold mb-4 text-gray-800">Payment Failed</h1>
            ...
            <div className="space-y-4">
              ...
              <Link to="/contact" className="btn btn-outline border-npc-gold text-npc-gold hover:bg-npc-gold hover:text-white w-full">
                Contact Support
              </Link>
            </div>
          </div>
